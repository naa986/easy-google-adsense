...
if (!class_exists('EASY_GOOGLE_ADSENSE')) {
    ...
    class EASY_GOOGLE_ADSENSE {
        ...
        function add_adsense_auto_ads_code() {
            ...
            $output = <<<EOT
            <!-- auto ad code generated by Easy Google AdSense plugin v{$this->plugin_version} -->
            <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-{$publisher_id}"{$custom_atts} crossorigin="anonymous"></script>      
...
EOT;
        ...
        function wp_body_open() {
            ...
            $output = <<<EOT
            <!-- auto ad code generated by Easy Google AdSense plugin v{$this->plugin_version} -->
            <amp-auto-ads type="adsense" data-ad-client="ca-{$publisher_id}"{$custom_atts}></amp-auto-ads>      
            <!-- Easy Google AdSense plugin -->
EOT;
